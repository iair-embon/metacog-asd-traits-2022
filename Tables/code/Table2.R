...
basename(getwd())               
filepath <- root$find_file("Data/Regression_Results/All_participants_Non_Exclusion/MixedLogisticRegressionAnalysis.RData")
load(file= filepath)
...
gt::gtsave(as_gt(table2), file = "Tables/Tables/All_participants_Non_Exclusion/MixedLogisticRegressionAnalysis.png")

# data model 2
### load mixed logistic regression model 
filepath <- root$find_file("Data/Regression_Results/All_participants_Non_Exclusion/MixedLogisticRegressionAnalysis_2.RData")
load(file= filepath)
...
gt::gtsave(as_gt(table2_2), file = "Tables/Tables/All_participants_Non_Exclusion/MixedLogisticRegressionAnalysis_2.png")
