...
## data model 2
filepath <- root$find_file("Data/Regression_Results/Non_Exclusion_Criteria/AUROC2_AQ_linear_model_2.RData")
load(file= filepath)
...
gt::gtsave(as_gt(table1_2), file = "Tables/Tables/Non_Exclusion_Criteria/AUROC2_AQ_linear_model_2.png")
