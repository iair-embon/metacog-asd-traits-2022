...
save(a, file = "Data/Regression_Results/All_participants_Non_Exclusion/ConfidenceMean_AQ_linear_model.RData")
...
power <- pwr.f2.test(u = 5, # number of iv
                     ...
                     f2 =  0.007186/(1- 0.007186), # effect size
...
save(a2, file = "Data/Regression_Results/All_participants_Non_Exclusion/ConfidenceMean_AQ_linear_model_2.RData")
