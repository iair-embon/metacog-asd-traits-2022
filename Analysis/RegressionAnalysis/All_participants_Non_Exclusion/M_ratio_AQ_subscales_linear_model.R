...
save(a, file = "Data/Regression_Results/All_participants_Non_Exclusion/M_ratio_AQ_subscales_linear_model.RData")
...
save(a2, file = "Data/Regression_Results/All_participants_Non_Exclusion/M_ratio_AQ_subscales_linear_model_2.RData")

# power analysis
power <- pwr.f2.test(u = 5, # number of iv
                     v = a2$df.residual, # degree of freedom
                     f2 = 0.01156/(1-0.01156), # effect size
                     sig.level = 0.05) # alpha
