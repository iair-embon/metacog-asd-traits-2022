...
# preprocessing
df_total$gender <- ifelse(df_total$gender == "Male",1,0)
...
save(a_log, file = "Data/Regression_Results/All_participants_Non_Exclusion/MixedLogisticRegressionAnalysis.RData")
...
save(a_log2, file = "Data/Regression_Results/All_participants_Non_Exclusion/MixedLogisticRegressionAnalysis_2.RData")
