...
save(a, file = "Data/Regression_Results/All_participants_Non_Exclusion/AUROC2_AQ_linear_model.RData")
...
power <- pwr.f2.test(u = 5, # number of iv
                     ...
                     f2 = 0.02219 /(1-0.02219), # effect size
...
save(a2, file = "Data/Regression_Results/All_participants_Non_Exclusion/AUROC2_AQ_linear_model_2.RData")

# power analysis
power <- pwr.f2.test(u = 1, # number of iv
                     v = a2$df.residual, # degree of freedom
                     f2 = 0.00657/(1-0.00657), # effect size 
                     sig.level = 0.05) # alpha
