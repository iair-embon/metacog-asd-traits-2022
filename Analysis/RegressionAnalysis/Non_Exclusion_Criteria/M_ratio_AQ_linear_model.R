...
save(a, file = "Data/Regression_Results/Non_Exclusion_Criteria/M_ratio_AQ_linear_model.RData")
...
save(a2, file = "Data/Regression_Results/Non_Exclusion_Criteria/M_ratio_AQ_linear_model_2.RData")
