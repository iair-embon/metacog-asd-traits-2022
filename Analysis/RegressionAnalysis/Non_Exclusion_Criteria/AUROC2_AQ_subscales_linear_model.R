...
save(a, file = "Data/Regression_Results/Non_Exclusion_Criteria/AUROC2_AQ_subscales_linear_model.RData")
...
save(a2, file = "Data/Regression_Results/Non_Exclusion_Criteria/AUROC2_AQ_subscales_linear_model_2.RData")
