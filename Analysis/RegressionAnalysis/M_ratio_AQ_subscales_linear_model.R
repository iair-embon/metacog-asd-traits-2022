...
save(a, file = "Data/Regression_Results/M_ratio_AQ_subscales_linear_model.RData")
...
power <- pwr.f2.test(u = 7, # number of iv
                     ...
                     f2 = 0.01572/(1-0.01572), # effect size
...
save(a2, file = "Data/Regression_Results/M_ratio_AQ_subscales_linear_model_2.RData")

# power analysis
power <- pwr.f2.test(u = 5, # number of iv
                     v = a2$df.residual, # degree of freedom
                     f2 = 0.00174/(1-0.00174), # effect size
                     sig.level = 0.05) # alpha
