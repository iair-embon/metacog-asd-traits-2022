...
df_total$AQ_test.norm <-  (df_total$AQ_test - mean(df_total$AQ_test)) / sd(df_total$AQ_test)
...
a_log <- glmer(discrimination_is_correct ~ confidence_key.norm +
                 confidence_key.norm:AQ_test.norm +
                 confidence_key.norm:gender +
                 confidence_key.norm:age.norm +
                 confidence_key.norm:AQ_test.norm:gender +
                 confidence_key.norm:AQ_test.norm:age.norm +
                 (1|Participant),
               data = df_total,
               family = binomial,
